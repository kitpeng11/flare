...
class HyperParameterMasking():
    ...
    def mask2cutoff(cutoffs, cutoffs_mask):
        ...
        if (ncutoffs > 3):
            scalar_cutoff_m3b = cutoffs[3]

        if (scalar_cutoff_2 == 0):
            scalar_cutoff_2 = np.max([scalar_cutoff_3, scalar_cutoff_mb, scalar_cutoff_m3b])

        if (cutoffs_mask is None):
            return scalar_cutoff_2, scalar_cutoff_3, scalar_cutoff_mb, scalar_cutoff_m3b,\
                None, None, None, \
        ...
        cutoff_m3b = cutoffs_mask.get('cutoff_m3b', None)
        ...
        if cutoff_m3b is not None:
            scalar_cutoff_m3b = np.max(cutoff_m3b)
        else:
            nm3b = 1
        ...
        return scalar_cutoff_2, scalar_cutoff_3, scalar_cutoff_mb, scalar_cutoff_m3b,\
            ...
            nspecie, n2b, n3b, nmb, nm3b, specie_mask, bond_mask, cut3b_mask, mb_mask
